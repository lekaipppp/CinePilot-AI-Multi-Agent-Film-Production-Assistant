    ...
    return (
      <Empty className="rounded-2xl border border-dashed border-border/70 bg-card/40 py-14">
        <EmptyHeader>
          ...
          <EmptyDescription>
            This agent needs a screenplay before it can produce output.
            Head back to the overview, paste or upload your script, and
            start the analysis.
          </EmptyDescription>
        </EmptyHeader>
    ...
    return (
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2 text-sm text-amber">
          ...
          Agent is still working — results stream in as soon as the
          handoff completes.
        </div>
